...
export const EmployeeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gitPodReactSpringJpaApp.employee.delete.question">
        <Translate contentKey="gitPodReactSpringJpaApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
