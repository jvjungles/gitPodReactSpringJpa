...
export const CountryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gitPodReactSpringJpaApp.country.delete.question">
        <Translate contentKey="gitPodReactSpringJpaApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
