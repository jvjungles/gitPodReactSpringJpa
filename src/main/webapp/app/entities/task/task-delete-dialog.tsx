...
export const TaskDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gitPodReactSpringJpaApp.task.delete.question">
        <Translate contentKey="gitPodReactSpringJpaApp.task.delete.question" interpolate={{ id: taskEntity.id }}>
