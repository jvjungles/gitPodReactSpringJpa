...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gitPodReactSpringJpaApp.department.delete.question">
        <Translate contentKey="gitPodReactSpringJpaApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
