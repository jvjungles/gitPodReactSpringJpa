...
import { getEntities as getFeras } from 'app/entities/fera/fera.reducer';
...
export const DepartmentUpdate = () => {
  ...
  const feras = useAppSelector(state => state.fera.entities);
  ...
  const saveEntity = values => {
    const entity = {
      ...
      location: feras.find(it => it.id.toString() === values.location.toString()),
    };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gitPodReactSpringJpaApp.department.home.createOrEditLabel" data-cy="DepartmentCreateUpdateHeading">
            <Translate contentKey="gitPodReactSpringJpaApp.department.home.createOrEditLabel">Create or edit a Department</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gitPodReactSpringJpaApp.department.departmentName')}
              ...
              <ValidatedField
                ...
                name="location"
                data-cy="location"
                label={translate('gitPodReactSpringJpaApp.department.location')}
                type="select"
              >
                <option value="" key="0" />
                {locations
