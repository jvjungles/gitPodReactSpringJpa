  ...
  return (
    <div>
      <h2 id="department-heading" data-cy="DepartmentHeading">
        <Translate contentKey="gitPodReactSpringJpaApp.department.home.title">Departments</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gitPodReactSpringJpaApp.department.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/department/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gitPodReactSpringJpaApp.department.home.createLabel">Create new Department</Translate>
          </Link>
        </div>
      </h2>
        ...
        {departmentList && departmentList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="gitPodReactSpringJpaApp.department.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="gitPodReactSpringJpaApp.department.departmentName">Department Name</Translate>
                </th>
                <th>
                  <Translate contentKey="gitPodReactSpringJpaApp.department.location">Location</Translate>
                </th>
                <th>
                  <Translate contentKey="gitPodReactSpringJpaApp.department.location">Location</Translate>
                </th>
            ...
            <tbody>
              {departmentList.map((department, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{department.location ? <Link to={`/fera/${department.location.id}`}>{department.location.id}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gitPodReactSpringJpaApp.department.home.notFound">No Departments found</Translate>
            </div>
          )
        )}
      </div>
