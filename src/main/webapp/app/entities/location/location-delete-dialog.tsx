...
export const LocationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gitPodReactSpringJpaApp.location.delete.question">
        <Translate contentKey="gitPodReactSpringJpaApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
