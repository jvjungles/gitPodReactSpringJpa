...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './fera.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FERA_LIST actions', async () => {
    ...
    it('dispatches FETCH_FERA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FERA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FERA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FERA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FERA actions', async () => {
      const expectedActions = [
        {
