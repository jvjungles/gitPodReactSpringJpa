...
export const RegionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gitPodReactSpringJpaApp.region.delete.question">
        <Translate contentKey="gitPodReactSpringJpaApp.region.delete.question" interpolate={{ id: regionEntity.id }}>
