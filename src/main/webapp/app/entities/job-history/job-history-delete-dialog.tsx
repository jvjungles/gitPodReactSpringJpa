...
export const JobHistoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gitPodReactSpringJpaApp.jobHistory.delete.question">
        <Translate contentKey="gitPodReactSpringJpaApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
