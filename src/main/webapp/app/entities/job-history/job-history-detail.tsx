    ...
    <Row>
      <Col md="8">
        <h2 data-cy="jobHistoryDetailsHeading">
          <Translate contentKey="gitPodReactSpringJpaApp.jobHistory.detail.title">JobHistory</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="endDate">
              <Translate contentKey="gitPodReactSpringJpaApp.jobHistory.endDate">End Date</Translate>
            </span>
          </dt>
          <dd>{jobHistoryEntity.endDate ? <TextFormat value={jobHistoryEntity.endDate} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="language">
              <Translate contentKey="gitPodReactSpringJpaApp.jobHistory.language">Language</Translate>
            </span>
          </dt>
          <dd>{jobHistoryEntity.language}</dd>
          <dt>
            <Translate contentKey="gitPodReactSpringJpaApp.jobHistory.job">Job</Translate>
          </dt>
          ...
          <dt>
            <Translate contentKey="gitPodReactSpringJpaApp.jobHistory.employee">Employee</Translate>
          </dt>
